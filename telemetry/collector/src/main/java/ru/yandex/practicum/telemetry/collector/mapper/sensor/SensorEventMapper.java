...
public class SensorEventMapper {
    ...
    private static LightSensorAvro mapToLightSensorAvro(LightSensorEvent event) {
    ...
    private static ClimateSensorAvro mapToClimateSensorAvro(ClimateSensorEvent event) {
    ...
    private static MotionSensorAvro mapToMotionSensorAvro(MotionSensorEvent event) {
    ...
    private static SwitchSensorAvro mapToSwitchSensorAvro(SwitchSensorEvent event) {
        return SwitchSensorAvro.newBuilder()
                .setState(event.isState())
                .build();
    }

    private static TemperatureSensorAvro mapToTemperatureSensorAvro(TemperatureSensorEvent event) {
